...
export default function AboutMe() {
    ...
    const imageRef = useRef(null); // ref for image container
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex md:order-1 order-2 justify-center md:justify-end">
                    <div
                        ...
                        className="relative overflow-hidden md:w-[700px] md:h-[700px] w-64 h-64 rounded-3xl  backdrop-blur-xl flex items-center justify-center"
                    >
                        <img
                            ref={imageRef}
                            src="/Images/Home/NFV2.png"
                            alt="Nimur Rahman Nerob"
                            className="w-full h-full overflow-hidden rounded-3xl object-contain "
                        />
                    </div>
                </div>
                ...
                <div className="about-text text-center md:order-2 order-1 md:text-left">
                    ...
                    <div className=" mt-6 flex flex-wrap gap-4 justify-center md:justify-start">
                        {[
                            ...
                            <span
                                key={index}
                                className=" px-4 py-2 bg-white/10 backdrop-blur rounded-lg text-primary border border-primary hover:bg-white/20 hover:scale-110 transition transform"
                            >
                                {skill}
                            </span>
                        ))}
